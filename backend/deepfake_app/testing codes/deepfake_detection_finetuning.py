...
# CSV logging path
CSV_PATH = os.path.join(settings.BASE_DIR, "deepfake_app/finetuning_debug_results.csv")
...
def generate_gradcam_and_ensemble_predict(request, img_path, true_label="Unknown"):
    ...
    vit_prob = probs["vit"]
    if vit_prob >= 0.92 and cnn_ensemble >= 0.92 and forensic >= 0.55:
